...
const car = new Car('audi', 'q6', '2020');
console.log(car);
//Ваш код
...
const rectangle2 = new Rectangle(6, 10);
...
const student = new Student('Ilya', 20, 3);
console.log(student);
...
const student2 = new Student('Anton', 19, 2);
console.log(`Новая оценка студента ${student2.name} - ${student2.increaseGrade()}`);
...
const book2 = new Book('Война и мир', 'Л.Н.Толстой', 1869);
...
// 	}
// }
// const account = new BankAccount(123456, 500000);
// console.log(account);
//Задание 14
...
// }
// const account2 = new BankAccount(456789, 100000);
// console.log(account2.deposit(50000));
...
const account3 = new BankAccount(300000);
console.log(account3.withdraw(350000));
...
const animal2 = new Animal('Cat', 'Mrrrr');
animal2.makeSound();
//Задание 18
...
const calculator = new Calculator(55, 5);
